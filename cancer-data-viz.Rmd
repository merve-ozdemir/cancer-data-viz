...
Overall, there doesn't seem to be a starking difference in the age distribution across cancers. What about gender?
...
Finally, I wanted to see what kind of treatments these patients received, how common each treatment was, and whether one type of cancer got treated with a specific treatment more than others, etc. Below I explored the trends with different types of treatments included in the dataset. 
